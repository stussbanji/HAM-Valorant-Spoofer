...
C:/temp/amdw.exe /SS "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /BS "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /CS "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /SU AUTO
C:/temp/amdw.exe /SM "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /SP "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /SV "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /CM "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /CV "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"
C:/temp/amdw.exe /SK "%RANDOM%%RANDOM%%RANDOM%%RANDOM%"

C:/temp/volid.exe C: %random%-%RANDOM%
C:/temp/volid.exe E: %RANDOM%-%RANDOM%
C:/temp/volid.exe F: %RANDOM%-%RANDOM%
C:/temp/volid.exe G: %RANDOM%-%RANDOM%
C:/temp/volid.exe H: %RANDOM%-%RANDOM%
C:/temp/volid.exe A: %RANDOM%-%RANDOM%
